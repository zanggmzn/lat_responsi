...
class HalamanOlahraga extends StatefulWidget {
  const HalamanOlahraga({super.key});

  @override
  State<HalamanOlahraga> createState() => _HalamanOlahragaState();
}

class _HalamanOlahragaState extends State<HalamanOlahraga> {
  ...
  fetchHome() async {
    ...
    var url = "https://api-berita-indonesia.vercel.app/cnn/olahraga";
